...
export const domestic = [
  {
    ...
    price: null,
    hideFlight: true,
    image: "https://travelogyindia.b-cdn.net/storage/app/upload/havelock-island-in-andaman-banner.jpg",
  ...
  },
  {
    ...
    price: null,
    hideFlight: true,
    image: 'https://images.unsplash.com/photo-1677769608829-1534f945c1df?auto=format&fit=crop&w=1200&q=80',
  ...
  },
  {
    ...
    price: null,
    hideFlight: true,
    image: 'https://images.unsplash.com/photo-1661174607003-d9d36388c916?auto=format&fit=crop&w=1200&q=80',
  ...
  },
  {
    ...
    price: null,
    hideFlight: true,
    image: 'https://wallpapers.com/images/hd/kedarnath-temple-crowd-4k-x7v0dhhuw4ivif94.jpg',
  ...
  },
  {
    ...
    price: null,
    hideFlight: true,
    image: 'https://www.stayvista.com/blog/wp-content/uploads/2024/10/Sonmarg_Kashmir.jpg',
  ...
  },
  {
    ...
    price: null,
    hideFlight: true,
    image: 'https://i.pinimg.com/originals/03/9c/93/039c93b4239d7f70fbfa21fc272e0fe7.jpg',
  ...
  },
  {
    ...
    price: null,
    hideFlight: true,
    image: 'https://images.jansatta.com/2025/08/How-old-is-Vaishno-Devi-temple.jpg',
    ...
    hideFlight: true, image: 'https://unsplash.com/photos/NhM4blzqpIs/download?force=true&w=1400', desc: 'Three nights in Guwahati with return flights from Mumbai, Kamakhya VIP darshan, a Brahmaputra sunset cruise and Pobitora wildlife safari.', tags: ['Flights Included', 'Twin Sharing', 'Minimum 4 Guests'], promoEyebrow: 'Your Journey, Our Responsibility', promoTitle: 'Discover Spiritual Guwahati', promoLine: 'The Spiritual Heart of Assam', specialHeading: 'Spiritual. Nature. Culture. Shopping.', stays: ['3 Nights / 4 Days', 'Departure: Mumbai', 'Flights Included'], gallery: [{ src: 'https://unsplash.com/photos/NhM4blzqpIs/download?force=true&w=1400', alt: 'Kamakhya Temple in Guwahati, Assam' }, { src: 'https://unsplash.com/photos/5WDMT98VnSI/download?force=true&w=1400', alt: 'Sunset over the Brahmaputra River in Assam' }, { src: 'https://unsplash.com/photos/Iw8NcX9q7dM/download?force=true&w=1400', alt: 'One-horned rhinoceros in Assam' }], galleryCaptions: ['Kamakhya Temple · Guwahati', 'Brahmaputra sunset cruise', 'One-horned rhino · Assam'], groupTitles: ['Spiritual Guwahati', 'River & Culture', 'Nature & Shopping'], experienceGroups: [['Spiritual Guwahati', 'Kamakhya Temple VIP darshan', 'Umananda Temple', 'Navagraha Temple', 'Sukreswar Ghat'], ['River & Culture', 'Peacock Island', 'Brahmaputra sunset cruise', 'Srimanta Sankardev Kalakshetra', 'Assam State Zoo'], ['Nature & Shopping', 'Pobitora Wildlife Sanctuary', 'One-horned rhinoceros safari', 'Private sightseeing vehicle', 'Fancy Bazaar shopping']], itinerary: [{ title: 'Arrival & Kamakhya Temple Darshan', copy: 'Arrive at Guwahati Airport, proceed for assisted VIP darshan at Kamakhya Temple, check in to your hotel and enjoy an evening at leisure.' }, { title: 'River Island & Brahmaputra Cruise', copy: 'Visit Umananda Temple on Peacock Island, Navagraha Temple and Sukreswar Ghat, followed by a Brahmaputra sunset cruise.' }, { title: 'Pobitora Wildlife Sanctuary Excursion', copy: 'Take a jeep safari in Pobitora Wildlife Sanctuary to spot one-horned rhinoceroses and other wildlife, then return for shopping at Fancy Bazaar.' }, { title: 'Local Sightseeing & Departure', copy: 'Depending on flight time, visit Assam State Zoo and Srimanta Sankardev Kalakshetra before your airport transfer and return flight to Mumbai.' }], inclusions: ['Mumbai–Guwahati return economy airfare', 'Three nights’ hotel stay', 'Brahmaputra sunset cruise', 'Airport transfers', 'Private vehicle for sightseeing', 'Kamakhya Temple VIP darshan assistance', 'Pobitora Wildlife Jeep Safari', 'Driver allowance, toll tax and parking charges'], exclusions: ['Lunch and dinner', 'Personal expenses', 'Camera fees, if applicable', 'Travel insurance', 'Anything not mentioned under inclusions'], benefits: ['Twin-sharing basis', 'Minimum four persons required', 'Spiritual and cultural experience', 'Private sightseeing vehicle', 'Flights included from Mumbai'], tagline: 'Book Now with Tourswale' },
  {
    ...
    promoEyebrow: 'Your Journey, Our Responsibility',
    promoTitle: 'South India Grandeur',
  ...
  },
  {
    ...
    location: 'Cochin, Munnar, Kumarakom',
    days: 5,
    price: null,
    hideFlight: true,
    image: 'https://images.unsplash.com/photo-1616388969587-8196f32388b4?auto=format&fit=crop&w=1200&q=80',
  ...
  },
  {
    ...
    location: 'Palani, Madurai, Kumbakonam, Chidambaram, Kancheepuram',
    days: 10,
    price: null,
    hideFlight: true,
    image: 'https://images.unsplash.com/photo-1665003815164-8f5bc853ef44?auto=format&fit=crop&w=1200&q=80',
  ...
  },
  {
    ...
    location: 'Palani, Madurai, Kumbakonam, Chidambaram, Tirupati',
    days: 15,
    price: null,
    hideFlight: true,
    image: 'https://images.unsplash.com/photo-1692173248120-59547c3d4653?auto=format&fit=crop&w=1200&q=80',
    ...
    promoEyebrow: 'Your Spiritual Journey',
    promoTitle: 'Spiritual South India',
  ...
  },
  {
    ...
    price: null,
    hideFlight: true,
    image: 'https://images.unsplash.com/photo-1644773182204-f0bf03cae0cb?auto=format&fit=crop&w=1200&q=80',
  ...
  {
    slug: 'kerala-package-7n-8d',
    title: 'Kerala Package – Munnar, Thekkady, Kumarakom, Kovalam & Cochin',
    location: 'Kerala',
    days: 8,
    price: null,
    hideFlight: true,
    image: 'https://www.india.com/wp-content/uploads/2024/08/Fort-Kochi.jpg',
    desc: 'An 8-day journey covering Munnar, Thekkady, Kumarakom, Kovalam, and Cochin.',
    tags: ['Munnar', 'Thekkady', 'Kumarakom', 'Kovalam', 'Cochin'],
    promoEyebrow: 'Your Trusted Travel Partner',
    promoTitle: "God's Own Country",
    promoLine: 'Munnar · Thekkady · Kumarakom · Kovalam · Cochin',
    specialHeading: 'Nature. Wildlife. Backwaters. Beaches.',
    ...
    experienceGroups: [
      ['Hill Stations', 'Cheeyapara & Valara Waterfalls', 'Eravikulam National Park', 'Munnar Photo Point', 'Mattupetty Dam'],
      ['Wildlife & Backwaters', 'Periyar Tiger Reserve', 'Elephant Safari', 'Kumarakom Bird Sanctuary', 'Sunset Views'],
    ...
    benefits: [
      'Houseboat stay experience in Kumarakom',
      'Comfortable AC transport',
      'Wildlife & Nature Trails',
      'Flexible accommodation options'
    ],
    policies: [
      {
        ...
        details: [
          'Munnar (2N): Munnar Castle / Munnar Queen Resort / Elixir Hills',
          'Thekkady (1N): PepperVine / The Elephant Court / Poetree Sarovar Portico',
          'Kumarakom (1N): Royal Riviera / Lake Song / The Zuri',
          'Kovalam (2N): Sagara Beach Resort / Uday Samudra (UDS) / Turtle on the Beach',
          'Cochin (1N): CRB Cochin Palace / The Dunes Cochin / Le Maritime'
        ]
      },
      {
        title: 'Vehicle Information',
  ...
  {
    slug: 'kerala-package-7n-8d-alleppey',
    title: 'Kerala Package – Munnar, Thekkady, Alleppey, Kovalam & Cochin',
    location: 'Munnar, Thekkady, Alleppey, Kovalam, Cochin',
    days: 8,
    price: null,
    hideFlight: true,
    image: 'https://images.unsplash.com/photo-1704365159747-1f7b8913044f?auto=format&fit=crop&w=1200&q=80',
    desc: 'An 8-day journey covering Munnar, Thekkady, Alleppey backwaters, Kovalam, and Cochin.',
    tags: ['Munnar', 'Thekkady', 'Alleppey', 'Kovalam', 'Cochin'],
    promoEyebrow: 'Your Trusted Travel Partner',
    promoTitle: 'Kerala Coastal Escape',
    promoLine: 'Munnar · Thekkady · Alleppey · Kovalam · Cochin',
    specialHeading: 'Nature. Wildlife. Backwaters. Beaches.',
    stays: ['7 Nights / 8 Days', 'Premium Stays', 'AC Houseboat (Optional)'],
    gallery: [
    ...
    inclusions: [
      ...
      'All Meals during the stay at Houseboat',
      'Pick up, drop & sightseeing by comfortable Ac Vehicle as per itinerary.',
      'Driving time – 8am to 7pm. No night drive will be entertained except in case of any emergency',
      'Toll / Parking / Driver Beta'
    ],
    exclusions: [
      'Any Train / Air Fare Tickets',
      'Entrance & Activity fee to various monuments, Museums, Temples, Pooja and Parks',
      'Medical & Travel Insurance',
      'Any Meals other than those mentioned above. (Anything extra ordered apart from the menu will be charged)',
      'Any portage at airports and hotels, Driver Tips, Laundry, Wines & Alcoholic beverages, Mineral Water, Telephonic Charges',
      '5% GST'
    ],
    benefits: [
    ...
    policies: [
      ...
      },
      {
        ...
        details: [
          'Check in – 12 PM & Check out – 9 AM',
          'Backwater cruising & overnight stay in private Deluxe Houseboat',
          'Meal Plan: Breakfast, Lunch, Evening Tea & Snacks, Dinner on board (Authentic Kerala style)',
          'Houseboat will be stationed at one place from 5.00pm to 8.00am due to Govt. restriction',
          'Deluxe Houseboat: AC Timing from 9 PM to 6 AM only',
          'Premium Houseboat: AC Timing from 12 PM to 9 AM (Bedroom only)',
  ...
  {
    slug: 'pancha-bhootham-temple-tour-9n-10d',
    title: 'Pancha Bhootham Temple Tour',
    location: 'Chennai, Tirupati, Kancheepuram, Tiruvannamalai, Trichy, Chidambaram',
    days: 10,
    price: null,
    hideFlight: true,
    image: 'https://images.unsplash.com/photo-1626621341517-bbf3d9990a23?auto=format&fit=crop&w=1200&q=80',
    desc: 'A 10-day spiritual journey covering the Pancha Bhootham temples and other iconic sites of South India.',
    tags: ['Chennai', 'Tirupati', 'Kancheepuram', 'Chidambaram'],
    promoEyebrow: 'Your Trusted Travel Partner',
    promoTitle: "Spiritual Awakening",
    promoLine: 'Tirupati · Kancheepuram · Tiruvannamalai · Trichy · Chidambaram',
    ...
    experienceGroups: [
      ['Andhra Pradesh', 'Tirupati Balaji Darshan', 'Srikalahasthi Temple', 'Kapila Theertham', 'Papavinasam Theertham'],
      ['Tamil Nadu Temples', 'Kancheepuram Temples', 'Vellore Golden Temple', 'Arunachaleshwara Temple', 'Thillai Nataraja Temple'],
    ...
    exclusions: [
      'Expenses of personal nature viz., telephone bills, Laundry, Tips and use of mini bar',
      'Any pooja, dharshan Entertainments, etc.',
      'Any meals & services other than those as mentioned in inclusions',
      'Entrance Fee & Guide Fee',
      'Alcoholic & non-alcoholic beverages during meals or otherwise',
      '5% GST'
    ],
    benefits: [
      'Comprehensive temple darshan',
      'Comfortable AC transport',
    ...
    policies: [
      {
        ...
        details: [
          'Tirupati (2N): Raj Park',
          'Kancheepuram (2N): Sree Sakthi Residency',
          'Tiruvannamalai (1N): Himalayaa',
          'Trichy (1N): Plaza Hotels',
          'Chidambaram (2N): Vandayar',
          'Chennai (1N): Southern Crest'
        ]
      },
      {
  ...
  {
    slug: 'kerala-package-8n-9d',
    title: 'Kerala Package – Munnar, Thekkady, Kumarakom, Kovalam & Cochin',
    location: 'Munnar, Thekkady, Kumarakom, Kovalam, Cochin',
    days: 9,
    price: null,
    hideFlight: true,
    image: 'https://images.unsplash.com/photo-1558971499-9b0683596aa2?auto=format&fit=crop&w=1200&q=80',
    desc: 'A 9-day journey covering Munnar, Thekkady, Kumarakom, Kovalam, and Cochin.',
    tags: ['Munnar', 'Thekkady', 'Kumarakom', 'Kovalam', 'Cochin'],
    promoEyebrow: 'Your Trusted Travel Partner',
    promoTitle: "God's Own Country",
    promoLine: 'Munnar · Thekkady · Kumarakom · Kovalam · Cochin',
    ...
    inclusions: [
      ...
      'Pick up, drop & sightseeing by comfortable Ac Vehicle as per itinerary.',
      'Driving time – 8am to 7pm. No night drive will be entertained except in case of any emergency',
      'Non Ac Rooms only provided at Hill Stations (Ex Munnar, Thekkady)',
      'Toll / Parking / Driver Beta'
    ],
    exclusions: [
      'Any Train / Air Fare Tickets',
      'Entrance & Activity fee to various monuments, Museums, Temples, Pooja and Parks',
      'Medical & Travel Insurance',
      'Any Meals other than those mentioned above. For the complimentary Breakfast fixed menu as per the Hotels/Resorts will be served & anything extra ordered apart from the menu will be charged & has to be paid to Hotel/Resorts directly',
      'Any portage at airports and hotels, Driver Tips, Laundry, Wines & Alcoholic beverages, Mineral Water, Telephonic Charges',
      '5% GST'
    ],
    benefits: [
      'Comprehensive Kerala coverage',
      'Comfortable AC transport',
      'Wildlife & Nature Trails',
      'Flexible accommodation options'
    ],
    policies: [
      {
        title: 'Accommodation Details',
        details: [
          'Munnar (3N): Munnar Castle / Munnar Queen Resort / Elixir Hills',
          'Thekkady (2N): PepperVine / The Elephant Court / Poetree Sarovar Portico',
          'Kumarakom (1N): Royal Riviera / Lake Song / The Zuri',
          'Kovalam (2N): Sagara Beach Resort / Uday Samudra (UDS) / Turtle on the Beach'
        ]
      },
      {
        ...
        details: [
          '2,3 Pax: Ac Dzire / Etios',
          '4,5 Pax: Ac Innova',
          '6,7,8,9,10 Pax: Ac 12 Seat Tempo',
          '11,12,13,14,15 Pax: Ac 17 Seat Tempo'
        ]
      }
    ],
    tagline: 'Book Now with Tourswale'
  ...
  {
    slug: 'himachal-punjab-9n-10d',
    title: 'Himachal & Punjab – Shimla to Amritsar',
    location: 'North India',
    days: 10,
    price: null,
    hideFlight: true,
    image: images.himachal,
    desc: 'A 10-day journey covering Shimla, Manali, Dharamshala, Dalhousie, and Amritsar.',
    tags: ['Shimla', 'Manali', 'Dharamshala', 'Dalhousie', 'Amritsar'],
    promoEyebrow: 'Your Trusted Travel Partner',
    promoTitle: "Discover North India",
    promoLine: 'Shimla · Manali · Dharamshala · Dalhousie · Amritsar',
    ...
    experienceGroups: [
      ['Shimla & Manali', 'Kufri Nature Park', 'Mall Road', 'Hadimba Temple', 'Solang Valley'],
      ['Dharamshala & Dalhousie', 'McLeodganj', 'Dalai Lama Palace', 'Khajjiar (Mini Switzerland)', 'Kalatope'],
    ...
    inclusions: [
      'Welcome Drink on arrival (Non alcoholic)',
      'Accommodation for 09 Nights and 10 Days',
      'Accommodation based on Dbl and Triple sharing basis',
      'All Tour by Tempo Traveller from Delhi to Delhi',
      '09 Breakfast and 09 Dinner',
      'All Parking Charges, Luxury tax, Toll Tax, Green Tax and Driver Stay'
    ],
    exclusions: [
      'GST 5% Extra',
      'Any monument entry fees / camera fees',
      ...
      'Entry fee for Rohtang pass by National Green Tribunal if apply',
      'Any air / train fare or any items not specified under inclusions',
      'Heater Requirement (directly contact Hoteliers)',
      'Any adventure activity skiing, paragliding etc',
      'Any personal Expenses - Laundry, shopping etc.'
    ],
    benefits: [
      'Covers 5 major destinations',
      'Includes Breakfast and Dinner',
      'Visit to India-Pakistan Attari Border',
      "Explore India's Mini Switzerland"
    ],
    policies: [
      {
        title: 'Accommodation Details',
        details: [
          'Shimla (2N): The Alpine Retreat or similar',
          'Manali (3N): King’s Land Cottage or similar',
          'Dharamshala (1N): Hotel Divyansh or similar',
          'Dalhousie (2N): Hotel S-1 or Similar',
          'Amritsar (1N): Hotel Grand Hridey or Similar'
        ]
      },
      {
        title: 'Important Remarks',
  ...
  {
    slug: 'navagraha-temple-tour-5n-6d',
    title: 'Navagraha Temple Tour',
    location: 'Tamil Nadu',
    days: 6,
    price: null,
    hideFlight: true,
    image: 'https://templetravels.in/wp-content/uploads/2025/07/Firefly_-Create-a-image-for-Navagraha-Temple-188468-1280x996.jpg',
    desc: 'A 6-day spiritual journey covering the Navagraha temples and iconic sites of Tamil Nadu.',
    tags: ['Trichy', 'Kumbakonam', 'Chidambaram', 'Chennai'],
    promoEyebrow: 'Your Trusted Travel Partner',
    promoTitle: "Spiritual Awakening",
    promoLine: 'Trichy · Tanjore · Kumbakonam · Chidambaram · Chennai',
    ...
    experienceGroups: [
      ['Trichy & Tanjore', 'Ranganathaswamy Temple', 'Ucchi Pillayar Temple', 'Kallanai Dam', 'Brihadeeswara Temple'],
      ['Kumbakonam & Chidambaram', 'Raahu Navagrahastalam', 'Guru Navagrahastalam', 'Chandra Navagrahastalam', 'Thillai Nataraja Temple'],
      ['Chennai Heritage', 'Kapaleeswarar Temple', 'Fort St.George', 'Marina Beach', 'San Thome Church']
    ],
    itinerary: [
    ...
    inclusions: [
      ...
      'Accommodation on Double / Triple sharing basis',
      'Daily Breakfast basis at all hotels',
      'All transfer and sightseeing by Air conditioned Dzire / Innova / 12 Seat Tempo / Mini Coach / Large Coach',
      'Driver allowance, toll, parking, fuel charge and interstate taxes. etc',
      'Applicable taxes for Room Rent, Breakfast and Transport'
    ],
    exclusions: [
      'Expenses of personal nature viz., telephone bills, Laundry, Tips and use of mini bar in the room',
    ...
    benefits: [
      'Comprehensive Navagraha Temple coverage',
      'Comfortable AC transport',
      'Spiritual & Heritage Trails',
      'Flexible accommodation options'
    ],
    policies: [
      {
        ...
        details: [
          'Trichy (1N): Plaza Hotels',
          'Kumbakonam (1N): DSR Madhanam Inn',
          'Chidambaram (1N): Vandayar',
          'Chennai (2N): Southern Crest'
        ]
      },
      {
        title: 'Important Remarks',
        details: [
          'Standard Check in time is 1300 HRS & Check out time is 1000 HRS.',
          'Package quoted with base category rooms in all the hotels.',
  ...
  {
    slug: 'south-india-leisure-tour-11n-12d',
    title: 'South India Leisure Tour',
    location: 'South India',
    days: 12,
    price: null,
    hideFlight: true,
    image: 'https://images.unsplash.com/photo-1660918738010-295b09857f93?auto=format&fit=crop&w=1200&q=80',
    desc: 'A 12-day extensive journey across South India covering temples, hill stations, and heritage cities.',
    tags: ['Tirupati', 'Bangalore', 'Mysore', 'Ooty', 'Madurai', 'Chennai'],
    promoEyebrow: 'Your Trusted Travel Partner',
    promoTitle: "South India Leisure Tour",
    ...
    experienceGroups: [
      ...
      ['Tamil Nadu Hills & Heritage', 'Ooty Lake & Botanical Garden', 'Dhyanalinga & Adiyogi Shiva', 'Meenakshi Amman Temple', 'Ranganathaswamy Temple'],
    ...
    benefits: [
      'Extensive South India coverage',
      'Comfortable AC transport',
      'Temples, Hills, and Heritage Trails',
      'Flexible accommodation options'
    ],
    policies: [
      {
        title: 'Accommodation Details',
        details: [
          'Tirupati (1N): Raj Park',
          'Bangalore (1N): The Prince Royal',
          'Mysore (1N): Crystal Paark Inn',
          'Ooty (1N): Kluney Manor',
          'Coimbatore (1N): Hotel Apple Park',
          'Madurai (1N): MMR Gardens',
          'Trichy (1N): Plaza Hotels',
          'Velankanni (1N): Clinton Paark Inn',
          'Pondicherry (1N): Anandha Inn',
          'Chennai (2N): Southern Crest'
        ]
      },
      {
  ...
  {
    slug: 'south-india-temple-tour-14n-15d',
    ...
    hideFlight: true,
    image: 'https://images.unsplash.com/photo-1692173248120-59547c3d4653?auto=format&fit=crop&w=1200&q=80',
    desc: 'A 15-day grand spiritual journey across the greatest temples and heritage sites of South India.',
    tags: ['Trichy', 'Madurai', 'Rameshwaram', 'Tirupati', 'Chennai'],
    promoEyebrow: 'Your Trusted Travel Partner',
    promoTitle: "South India Temple Tour",
    promoLine: 'Trichy · Madurai · Rameshwaram · Tanjore · Kumbakonam · Chidambaram · Pondicherry · Tirupati · Chennai',
    ...
    experienceGroups: [
      ['Trichy & Madurai', 'Ranganathaswamy Temple', 'Meenakshi Amman Temple', 'Kanyakumari', 'Vivekanandar Rock Memorial'],
      ['Rameshwaram & Tanjore', 'Ramanathaswamy Temple', 'Brihadeeswara Temple', 'Pichavaram Mangrove Forest', 'Thillai Nataraja Temple'],
    ...
    policies: [
      {
        ...
        details: [
          ...
          'Palani (1N): Ganpat Grand',
          'Madurai (1N): MMR Gardens',
          'Kanyakumari (1N): Seashore',
          'Tiruchendur (1N): Hotel Udhayam International',
          'Rameshwaram (1N): Royal Park',
          'Tanjore (1N): Star Residency',
          'Kumbakonam (1N): DSR Madhanam Inn',
          'Chidambaram (1N): Vandayar',
          'Pondicherry (1N): Anandha Inn',
          'Tiruvannamalai (1N): Himalayaa',
  ...
  {
    slug: 'bangalore-mysore-coorg-5n-6d',
    title: 'Bangalore Mysore Coorg Tour',
    location: 'Karnataka',
    days: 6,
    price: null,
    hideFlight: true,
    image: 'https://images.unsplash.com/photo-1600112356915-089abb8fc71a?auto=format&fit=crop&w=1200&q=80',
    desc: 'A 6-day refreshing journey across the silicon valley, the Scotland of India and the city of palaces.',
    tags: ['Bangalore', 'Coorg', 'Mysore'],
    promoEyebrow: 'Your Trusted Travel Partner',
    promoTitle: "Karnataka Landscapes",
    promoLine: 'Bangalore · Coorg · Mysore',
    ...
    experienceGroups: [
      ['Bangalore City', 'Lal Bagh Botanical Garden', 'Cubbon Park', 'Bannerghatta National Park', 'Iskcon Temple', 'Tippu Sultan Summer Palace'],
      ['Coorg Landscapes', 'Golden Temple (Bylekuppe)', 'Kaveri Nisargadhama', 'Abbey Falls', 'Madikeri Fort', "Raja's Seat"],
    ...
    exclusions: [
      ...
      'Alcoholic & non-alcoholic beverages during meals or otherwise',
      'Tips at restaurants, concierge and driver',
      'Non Ac Rooms only available at Hill Stations (Ex Coorg)',
      '5% GST'
    ],
    benefits: [
      'Refreshing Hill Station experience',
      'Comfortable AC transport',
  ...
  {
    slug: 'south-india-hill-station-tour-11n-12d',
    title: 'South India With Hill Station Tour',
    location: 'South India & Kerala',
    days: 12,
    price: null,
    hideFlight: true,
    image: '/images/temples-tea-estates.png',
    desc: 'A 12-day journey from the heritage cities of Tamil Nadu to the backwaters and misty hills of Kerala.',
    tags: ['Chennai', 'Pondicherry', 'Madurai', 'Kovalam', 'Munnar'],
    promoEyebrow: 'Your Trusted Travel Partner',
    promoTitle: "South India With Hill Station Tour",
    promoLine: 'Chennai · Pondicherry · Trichy · Rameshwaram · Madurai · Kanyakumari · Kovalam · Thekkady · Munnar',
    ...
    experienceGroups: [
      ['Tamil Nadu Heritage', 'Chennai City Tour', 'Mahabalipuram Shore Temple', 'Pondicherry French Quarter', 'Ranganathaswamy Temple', 'Meenakshi Amman Temple'],
      ['Coastal Landscapes', 'Rameshwaram', 'Kanyakumari Rock Memorial', 'Kovalam Beach', 'Trivandrum City Tour'],
    ...
    exclusions: [
      ...
      'Alcoholic & non-alcoholic beverages during meals or otherwise',
      'Tips at restaurants, concierge and driver',
      'Non Ac Rooms only available at Hill Stations (Ex Munnar, Thekkady)',
      '5% GST'
    ],
    benefits: [
      'Extensive South India and Kerala coverage',
      'Comfortable AC transport',
      'Temples, Beaches, and Hill Stations',
      'Flexible accommodation options'
    ],
    policies: [
      {
        ...
        details: [
          'Chennai (1N): Southern Crest',
          'Pondicherry (2N): Anandha Inn',
          'Trichy (1N): Plaza Hotels',
          'Rameshwaram (1N): Royal Park',
          'Madurai (1N): MMR Gardens',
          'Kanyakumari (1N): Seashore',
          'Kovalam (1N): Samudratheeram Beach Resort',
          'Thekkady (1N): Grand Thekkady',
          'Munnar (2N): Green Ridge'
        ]
      },
      {
        title: 'Important Remarks',
  ...
  {
    slug: 'chandigarh-manali-dharamshala-amritsar-10d',
    ...
    promoEyebrow: 'Your Trusted Travel Partner',
    promoTitle: "North India Wonders",
    promoLine: 'Chandigarh · Manali · Dharamshala · Amritsar',
    ...
    experienceGroups: [
      ['Himalayan Valleys', 'Jogini Waterfall', 'Solang Valley / Snow Point', 'Kullu Valley'],
      ['Spiritual Centers', 'Tibetan Monasteries', 'Dalai Lama Temple', 'Golden Temple'],
    ...
    inclusions: [
      ...
      'Water Rafting at Kullu (FREE)',
      'DJ nights and bonfire as per itinerary'
    ],
    exclusions: [
    ...
    benefits: [
      ...
      'Includes Train Journey',
      'Adventure & Spiritual trails',
      'New Year Special Departure'
    ],
    policies: [
      {
        title: 'Payment Terms',
        details: [
          'Total Tour Cost: Rs 15,000 per person',
          '1st instalment: 50% required for booking'
        ]
      },
      {
        title: 'Important Remarks',
...
export const international = [
  ...
  { slug: 'bali-luxury', title: 'Bali Luxury Escape', location: 'Bali, Indonesia', days: 7, price: 81500, image: images.bali, desc: 'Six nights in Bali with return flights from Mumbai, premium resort stay, private pool villa, water sports and curated island sightseeing.', tags: ['Flights Included', 'Private Pool Villa', 'July Departure'], promoEyebrow: 'Your Trusted Travel Partner', promoTitle: 'Summer in Amazing Bali', promoLine: 'Luxury Escape · Ubud · Kintamani · Uluwatu', specialHeading: 'Your Dream Bali Holiday Awaits', stays: ['6 Nights / 7 Days', '4 Nights Premium Resort', '2 Nights Private Pool Villa'], departureMonths: 'July Special Departure', departures: ['Selected July dates'], departureCities: ['Mumbai'], gallery: [{ src: 'https://images.unsplash.com/photo-1537996194471-e657df975ab4?auto=format&fit=crop&w=1400&q=85', alt: 'Traditional temple and Gate of Heaven in Bali' }, { src: 'https://images.unsplash.com/photo-1533669955142-6a73332af4db?auto=format&fit=crop&w=1400&q=85', alt: 'Nusa Penida coast in Bali' }, { src: 'https://images.unsplash.com/photo-1539367628448-4bc5c9d171c8?auto=format&fit=crop&w=1400&q=85', alt: 'Luxury private pool villa in Bali' }], galleryCaptions: ['Gate of Heaven · East Bali', 'Nusa Penida · Bali', 'Private pool villa experience'], groupTitles: ['Signature Experiences', 'Featured Attractions', 'Premium Stay'], experienceGroups: [['Signature Experiences', 'Water sports adventure', 'Bali Swing experience', 'Floating breakfast', 'Private pool villa stay'], ['Featured Attractions', 'Nusa Penida', 'Lempuyang Gate of Heaven', 'Tirta Gangga Water Palace', 'Uluwatu Temple & Kecak Dance'], ['Premium Stay', '4 nights premium resort', 'Deluxe Sky View room or similar', '2 nights private pool villa', 'Daily breakfast']], itinerary: [{ title: 'Arrival in Bali', copy: 'Arrive in Bali and meet your representative for a comfortable transfer to the hotel. Check in and enjoy the rest of the day at leisure.' }, { title: 'Water Sports Adventure', copy: 'Enjoy an exciting day of banana boat riding, jet skiing and parasailing with transfers arranged as per the itinerary.' }, { title: 'Uluwatu Tour', copy: 'Visit spectacular Uluwatu Temple perched above the ocean and experience the traditional Kecak Dance at sunset.' }, { title: 'East Bali Tour', copy: 'Discover Lempuyang Gate of Heaven and the elegant water gardens of Tirta Gangga Water Palace.' }, { title: 'Ubud & Kintamani Tour', copy: 'Spend a full day exploring Ubud, Kintamani, scenic landscapes and memorable local attractions.' }, { title: 'Floating Breakfast & Villa Leisure', copy: 'Enjoy a floating breakfast followed by leisure time in the privacy and comfort of your pool villa.' }, { title: 'Departure', copy: 'Check out after breakfast and transfer to the airport for your return flight.' }], inclusions: ['Return economy-class airfare from Mumbai', '6 nights’ accommodation with breakfast', '4 nights at Anantara Resort or similar', 'Deluxe Sky View room or similar', '2 nights in a private pool villa', 'Airport transfers', 'Sightseeing tours as per the itinerary', 'Water sports activities', 'Private pool villa experience'], exclusions: ['Visa fees unless specified', 'Travel insurance', 'Lunch and dinner unless specified', 'Personal expenses', 'Anything not mentioned under inclusions'], benefits: ['Perfect for couples and honeymooners', 'Ideal for families and groups', 'Private pool villa experience', 'Premium resort accommodation', 'Visa, hotel and flight assistance available'], tagline: 'Let’s make memories that last a lifetime.' },
  {
    ...
    price: null,
    image: images.dubai,
    desc: 'Experience the best of Dubai with city tours, desert safaris, and a complimentary limousine ride.',
    tags: ['Dubai', '4 Days', 'Desert Safari'],
    promoEyebrow: 'Tourswale Inaugural Offer',
    promoTitle: 'Experience Dubai',
    promoLine: 'City Tour · Desert Safari · Dhow Cruise',
    ...
    experienceGroups: [
      ['Tourswale Inaugural Offer', 'Complimentary 1 Hour Night Tour of Dubai', 'Stretch Limousine ride', 'Glass of Champagne (Non-Alcoholic)'],
      ['Included Tours', 'Half Day Dubai City Tour', 'Shopping Tour to Dragon Mart Dubai (2 hours stop)', 'Desert safari with BBQ dinner (Standard Camp)', 'Dhow creek cruise with Dinner'],
    ...
    inclusions: [
      '3N/4D accommodation',
      'Daily Breakfast',
      'Arrival transfers on shared basis (Dubai airport)',
      'Half Day Dubai City Tour',
      'Shopping Tour to Dragon Mart Dubai (2 hours stop with city tour)',
      'Desert safari with BBQ dinner (Standard Camp)',
      'Dhow creek cruise with Dinner',
      'Departure Transfers on shared basis (Dubai Airport)',
      'All tours on shared basis',
      'Complimentary 1 Hour Night Tour of Dubai in a Stretch Limousine (Inaugural Offer)'
    ],
    exclusions: [
      'Any personal expenses',
      'Tourism Dirham (to be paid directly at the Hotel)',
      'Travel insurance',
      'Anything not mentioned in the inclusions'
    ],
    benefits: [
      'Complimentary Limousine Night Tour',
      'Comprehensive sightseeing included',
      'Convenient shared transfers'
    ],
    policies: [
      {
        title: 'Terms & Conditions',
        details: [
          'Offer Valid for limited period only on first cum first serve basis',
          'Tourism Dirham to be paid directly at the Hotel',
  ...
  { slug: 'singapore-malaysia', title: 'Singapore & Malaysia', location: 'Asia', days: 7, price: 89999, hideFlight: true, image: images.singapore, desc: 'Sleek skylines, gardens and a vibrant culinary trail.', tags: ['Singapore', 'Kuala Lumpur'] },
  { slug: 'turkiye-highlights', title: 'Türkiye Highlights', location: 'Middle East', days: 8, price: 114999, hideFlight: true, image: images.turkiye, desc: 'Bazaars, minarets and Cappadocia skies.', tags: ['Istanbul', 'Cappadocia'] },
  ...
  { slug: 'new-york-experience', title: 'New York City Experience', location: 'USA', days: 7, price: 179999, hideFlight: true, image: images.usa, desc: 'Landmark neighbourhoods and the energy of Manhattan.', tags: ['Manhattan', 'Brooklyn'] },
  {
    ...
    days: 8,
    price: null,
    image: 'https://images.unsplash.com/photo-1575540291670-8d3b26f7d327?auto=format&fit=crop&w=1400&q=80',
    desc: 'Visit Zagreb, Plitvice, Zadar, Trogir, Split, Mostar, and Dubrovnik over 8 breathtaking days.',
    tags: ['Croatia', 'Europe', 'Plitvice Lakes'],
    promoEyebrow: 'Your Trusted Travel Partner',
    promoTitle: "Classic Croatia",
    promoLine: 'Zagreb · Plitvice · Zadar · Split · Dubrovnik',
    ...
    experienceGroups: [
      ['Historic Cities', 'Zagreb Walking Tour', 'Mostar & Stari Most', 'Diocletian’s Palace', 'Trogir Orientation'],
      ['Natural Wonders', 'Plitvice Lakes National Park', 'Optional Lake Bled (Slovenia)', 'Adriatic Sea Views'],
    ...
    inclusions: [
      ...
      'Accommodation in top 4-star category hotels',
      'Daily Continental buffet breakfast',
      '7 Indian Jain / Vegetarian / Non Vegetarian Dinners',
      'Guided tours of Zagreb, Zadar, Split & Dubrovnik',
      'Plitvice Lakes National Park visit',
      'All ground transportation by air-conditioned coaches',
      'Services of a Tour Manager',
      'Driver tips & Daily Mineral Water Bottle'
    ],
    exclusions: [
      'Optional tours (Slovenia, Kornati Island, Montenegro, etc.)',
      'Lunches and beverages other than specified',
      'Personal expenses',
      'Anything not mentioned under inclusions'
    ],
    benefits: [
      'Value-for-Money 8 Days holiday',
      'Professional Tour Manager included',
      'Indian Meals included',
      'Comprehensive Croatia coverage'
    ],
    policies: [
      {
        title: 'Accommodation Details',
        details: [
          'Zagreb (2N): Hotel Puntijar or similar',
          'Zadar (2N): Success Apartments or similar',
          'Split (1N): Hotel San Antonio or similar',
          'Dubrovnik (2N): Hotel Dubrovnik or similar'
        ]
      },
      {
        title: 'Optional Tours (Approx. Cost)',
        details: [
          'Full day tour of Slovenia: €165',
          'Kornati Island tour: €79',
          'Day trip to Montenegro: €62',
          'Schengen multiple entry visa required for optional tours to Slovenia & Montenegro'
        ]
      }
    ],
    tagline: 'Book Now with Tourswale'
  ...
  {
    slug: 'dubai-land-combo-packages',
    title: 'Dubai Land Combo Packages',
    location: 'Dubai, UAE',
    days: '4 to 6',
    price: null,
    image: 'https://images.unsplash.com/photo-1512453979798-5ea266f8880c?auto=format&fit=crop&w=1200&q=80',
    desc: 'Choose from meticulously crafted Land Combo Packages ranging from Glimpse to Dreamer (LP1 to LP7).',
    tags: ['Dubai', 'Customizable', 'Land Package'],
    promoEyebrow: 'Your Trusted Travel Partner',
    promoTitle: 'Dubai Combo Packages',
    promoLine: 'City Tour · Desert Safari · Dhow Cruise · Burj Khalifa',
    ...
    experienceGroups: [
      ['Standard Packages (LP1-LP5)', 'LP1 Glimpse (4 Days): City Tour + Desert Safari + Dhow Cruise', 'LP2 Discover (5 Days): LP1 + Burj Khalifa', 'LP3 Delight (6 Days): LP2 + Ferrari World & Abu Dhabi', 'LP4/LP5 Glimpse (5 Days): With Palm Jumeirah or Yas Island stay'],
    ...
    inclusions: [
      ...
      'Dubai City Tour with Shopping at Dragon Mart',
      'Desert Safari with BBQ Dinner (Standard Camp)',
      'Dhow Dinner Cruise at Dubai Creek',
      'Burj Khalifa At The Top (LP2 & LP3 only)',
      'Ferrari World & Abu Dhabi City Tour (LP3 only)',
      'All tours and transfers on shared basis (SIC/Semi-Pvt)'
    ],
    exclusions: [
    ...
    benefits: [
      ...
      'Convenient shared transfers',
      'Iconic Dubai and Abu Dhabi experiences'
    ],
    policies: [
      {
        title: 'Package Options',
        details: [
          'LP1 Glimpse (4 Days) / LP2 Discover (5 Days) / LP3 Delight (6 Days)',
          'LP4 Glimpse with Palm Jumeirah (5 Days)',
          'LP5 Glimpse with Yas Island (5 Days)',
          'LP6 Explorer Premium (5 Days)',
          'LP7 Dreamer Luxury (3 Days)'
        ]
      },
      {
        title: 'Important Information',
        details: [
          'All LP’s are available to book with minimum 3 Nights 4 Days stay (LP7 is 3 Days/2 Nights)',
          'All tours and activities on shared basis unless specified as Private/Semi-Pvt',
          'Semi Private LP’s include only point-to-point drop from Hotel to Airport (No stops)',
          'SIC operational days are subject to change (City Tours operate all days except Friday)',
          'Waiting Time for SIC Tours & Transfers: 10 minutes',
          'Height, weight, size, age restrictions and medical conditions apply to certain rides',
          'Wear comfortable shoes and clothes during Desert Safari',
          'Infants can be taken for Dune Bashing at the parents\' discretion. Guests with heart issues are not recommended to go for Dune Bashing',
          'Guests can avoid Dune Bashing and reach Safari camp directly (inform driver before start). No price reduction',
          'Max luggage dimensions per bag (H+W+L) must not exceed 158 cm (62 inches) – 1 piece + 1 hand luggage between 2 guests',
          'Abu Dhabi Grand Mosque: Body must be fully covered. No shorts, skirts, sleeveless, tight, swimwear, or transparent clothing',
          '100% penalty applies for no show, cancellation, or amendment in less than 96 hours'
        ]
      }
    ],
    tagline: 'Book Now with Tourswale'
  ...
  {
    slug: 'eastern-europe-7d',
    title: 'Eastern Europe 7 Days',
    location: 'Europe',
    days: 7,
    price: null,
    image: 'https://images.unsplash.com/photo-1549877452-9c387954fbc2?auto=format&fit=crop&w=1200&q=80',
    desc: 'Visit 4 countries in 7 days: Czech Republic, Austria, Hungary & Germany with top quality hotels and Indian meals.',
    tags: ['Eastern Europe', '4 Countries', '7 Days'],
    promoEyebrow: 'Your Trusted Travel Partner',
    promoTitle: 'Discover Eastern Europe',
    promoLine: 'Hungary · Austria · Slovakia · Czech Republic · Germany',
    ...
    experienceGroups: [
      ['Hungary & Slovakia', 'Budapest Guided Tour', 'Danube River Cruise', 'Horseman Show', 'Bratislava Orientation Tour'],
      ['Austria', 'Vienna Guided Tour', 'Schönbrunn Palace', 'Hofburg & Belvedere Palaces', 'St. Stephens Cathedral'],
    ...
    inclusions: [
      ...
      'Daily Continental buffet breakfast (6 Breakfasts)',
      'Unlimited Indian Vegetarian / Non-Vegetarian meals (5 Lunches, 6 Dinners)',
      'Special local delicacies in select countries',
      ...
      'TRAVEL TOURS SPECIAL: Ice-cream & tea in select cities, Bottle of mineral water every day'
    ],
    exclusions: [
      'Personal expenses and optional activities',
      'Anything not mentioned in the inclusions'
    ...
    benefits: [
      'Visit 4 countries in 7 days',
      'Choice of local meals in selected cities',
      'Comprehensive guided tours included'
    ],
    policies: [
      {
        title: 'Accommodation Details',
        details: [
          'Budapest (2 Nights): Hotel Leonardo / Hotel Mercure or similar',
          'Vienna (1 Night): Hotel Austria Trend / Hotel Mercure or similar',
          'Prague (2 Nights): Hotel Mercure / Hotel Holiday Inn or similar',
          'Munich (1 Night): Hotel Holiday Inn or similar'
        ]
      }
    ],
    tagline: 'Book Now with Tourswale'
  },
  {
    ...
    title: 'Eastern Europe 9 Days',
    location: 'Europe',
    days: 9,
    price: null,
    image: 'https://images.unsplash.com/photo-1519677100203-a0e668c92439?auto=format&fit=crop&w=1200&q=80',
    desc: 'Explore Vienna, Prague, Cesky Krumlov, Bratislava, and Budapest over 9 days with airfare and meals included.',
    tags: ['Eastern Europe', '9 Days', 'Flights Included'],
    promoEyebrow: 'Classic Holidays',
    promoTitle: 'Eastern Europe Tour',
    promoLine: 'Vienna · Prague · Cesky Krumlov · Budapest',
    ...
    experienceGroups: [
      ['Vienna & Prague', 'Schönbrunn Palace', 'Prague Castle & Charles Bridge', 'Vltava River Cruise'],
      ['Cesky Krumlov & Bratislava', 'Guided Tour of Cesky Krumlov', 'Bratislava Historic Bus Ride'],
    ...
    inclusions: [
      'Airfare / Train Fare',
      '08 Nights accommodation in well appointed rooms',
      'All Tours & Transportation in well appointed AC Vehicle',
      'All Meals by Maharaj / Chef',
    ...
    exclusions: [
      ...
      'Entry Fee to Any Monument, Park, Museum, Monastery or any other visiting places (unless specified)',
      'Payment for service provided on personal basis',
      'Insurance',
      'Personal expenses (Laundry, Drinks, Tips, Porterage, etc.)',
      'Cost for services not mentioned in "Inclusions"'
    ],
    benefits: [
      'Return Flights Included (Sharjah Transit)',
      'Meals crafted by Indian Maharaj / Chef',
      'Extensive multi-country sightseeing'
    ],
    policies: [
      {
        title: 'Accommodation Details',
        details: [
          'Prague (3 Nights): Hotel Taurus or similar',
          'Budapest (3 Nights): Hungaria City Center or similar',
          'Vienna (2 Nights): Hotel Austria Trend or similar'
        ]
      },
      {
        title: 'Flight Details',
        details: [
          'G9 407 (20MAY): Mumbai to Sharjah (4:55 - 6:20)',
          'G9 571 (20MAY): Sharjah to Vienna (7:25 - 11:40)',
          'G9 572 (28MAY): Vienna to Sharjah (12:30 - 20:10)',
          'G9 406 (28MAY): Sharjah to Mumbai (23:45 - 4:15)'
        ]
      },
      {
        title: 'Terms & Conditions',
        details: [
          'En route Lunch will be provided during long journeys.',
          'Classic Holidays will not be liable for any refund if flight is cancelled or delayed.',
          'Itinerary and Hotel may change without prior information as per convenience.'
        ]
      }
    ],
  ...
  {
    slug: 'best-of-europe-14d',
    title: 'Best of Europe 14 Days',
    location: 'Europe',
    days: 14,
    price: null,
    image: 'https://images.unsplash.com/photo-1499856871958-5b9627545d1a?auto=format&fit=crop&w=1200&q=80',
    desc: 'An unforgettable 14-day journey through Austria, Switzerland, France, Belgium, and the Netherlands.',
    tags: ['Best of Europe', '14 Days', 'Multi-Country'],
    promoEyebrow: 'Classic Holidays',
    promoTitle: 'Best of Europe',
    promoLine: 'Austria · Switzerland · France · Belgium · Netherlands',
    ...
    experienceGroups: [
      ['Austria', 'Swarovski Crystal Museum', 'Orientation Tour of Innsbruck', 'Salzburg Guided Tour', 'Golden Roof'],
      ['Switzerland', 'Mt. Titlis with Ice Flyer', 'Jungfraujoch - Top Of Europe', 'Rhine Falls Boat Ride (opt)', 'Lucerne & Bern Tours'],
      ['France', 'Paris Guided City Tour', 'Seine River Cruise', 'Eiffel Tower Level 3 (opt)', 'Disneyland Paris'],
    ...
    inclusions: [
      'Airfare',
      'One Time Visa Charges for Maharashtra issued passport',
      '13 Nights accommodation based on 3/4 star properties',
      '13 Breakfasts, 13 Lunches, and 13 Dinners',
      'Services of a professional tour manager',
      'All hotel taxes included',
      'Coach tours, transfers, entrance fee, sightseeing as indicated'
    ],
    exclusions: [
      'Porterage',
      'Any Supplements for un-social hours',
      'Insurance or Medical Cover',
      'MANDATORY DRIVER TIPS AT EUR 3 PER PERSON PER DAY',
      'Trummelbach Falls Entry, Rhine Falls Boat Ride, Eiffel Tower Level 3 Entry'
    ],
    benefits: [
      'Visit 5 Countries in 14 Days',
      'Swiss to Paris TGV Fast Train Experience',
      'Disneyland Paris 1 Park Included'
    ],
    policies: [
      {
        title: 'Important Information',
        details: [
          'Check-in Time in Innsbruck Hotel is after 15:00 Hrs.',
          'Itinerary subject to change.',
          'CTSP.LTD Terms and Conditions Apply.'
        ]
      }
    ],
    tagline: 'Classic Holidays Special'
